...
public class ListPelanggan extends javax.swing.JDialog {
    ...
    private void level(){
        if(sesi.getLevel().equals("1")){
            Ubah1.setVisible(true);
        }else if(sesi.getLevel().equals("2")){
            Ubah1.setVisible(false);
    ...
    private void getData(){
        String[] judul={"ID Pelanggan","Nometer","Nama","Alamat","Kode Tarif"};
        ...
        try{
            String query="select * from tbl_pel";
        ...
        while(rs.next()){
            ...
            System.out.println("Error List Pelanggan : "+e);
        }
    }
    ...
    private void cari(){
        ...
        table.addColumn("Nometer");
        table.addColumn("Nama");
        table.addColumn("Alamat");
        table.addColumn("Kode Tarif");
        try {
            String sql = "Select * from tbl_pel where nama like '%" + txtCari.getText() + "%'" +
            "or nometer like '%" + txtCari.getText() + "%' or kdtarif like '%"+txtCari.getText()+"%'";
    ...
    private void ubah(){
        try{
            ...
            FrmPelanggan a = new FrmPelanggan(new javax.swing.JFrame(),true);
            a.setUpdate(true);
    ...
    private void delete(){
        try{
            ...
            String nama = tbl.getValueAt(i, 2).toString();
            String sql = "DELETE FROM tbl_pel where idpel= '"+id+"'";
            if(JOptionPane.showConfirmDialog(rootPane,"Apakah anda akan menghapus data\n"+ nama,
    ...
    private void initComponents() {
        ...
        jLabel1.setText("*Form ini berfungsi untuk menampilkan data pelanggan ");
        ...
        jLabel4.setText("Daftar Pelanggan");
        ...
        Ubah1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/16/edit.png"))); // NOI18N
        Ubah1.setText("Ubah");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        if(JOptionPane.showConfirmDialog(rootPane, "Anda akan keluar dari List pelanggan?",
