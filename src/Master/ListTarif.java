 ...
 * @author LENOVO
 */
public class ListTarif extends javax.swing.JDialog {
      SessionLogin sesi= new SessionLogin();
      DefaultTableModel table;
    /**
     * Creates new form ListTarif
     */
    public ListTarif(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setTitle(".:List Tarif Listrik:.");
    ...
    private void getData(){
        String[] judul={"Kode Tarif","Daya","Tarif Per/KWH"};
        ...
        try{
            String query="select kdtarif,daya,tarifperkwh from tbl_trf";
    ...
    private void cari(){
        ...
        table.addColumn("Kode Tarif");
        table.addColumn("Daya");
        table.addColumn("Tarif/KWH");
        try {
            String sql = "Select kdtarif,daya,tarifperkwh from tbl_trf where daya like '%" + txtCari.getText() + "%'" +
            "or tarifperkwh like '%" + txtCari.getText()+"%'";
    ...
    private void ubah(){
        try{
            ...
            String kdtarif = tbl.getValueAt(i, 0).toString();
            FrmTarif a = new FrmTarif(new javax.swing.JFrame(),true);
            a.setUpdate(true);
            a.setKdTarif(kdtarif);
            a.setVisible(true);
    ...
    private void delete(){
         try{
            ...
            String sql = "DELETE FROM tbl_trf where kdtarif= '"+id+"'";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("*Form ini berfungsi untuk menampilkan tarif listrik");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Listrik Pasca Bayar");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        if(JOptionPane.showConfirmDialog(rootPane, "Anda akan keluar dari List Tarif?",
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        // TODO add your handling code here:
         if(JOptionPane.showConfirmDialog(rootPane, "Apakah anda akan keluar dari list tarif?","Informasi",JOptionPane.CANCEL_OPTION,
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListTarif.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListTarif dialog = new ListTarif(new javax.swing.JFrame(), true);
